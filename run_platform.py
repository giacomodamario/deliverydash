...
Credentials must be set in .env file (GLOVO_EMAIL, GLOVO_PASSWORD, etc.)
"""
...
def get_credentials(platform: str):
    """Get credentials from .env settings only."""
...
def main():
    ...
    if not email or not password:
        ...
        print(f"Error: Credentials not configured.")
        print(f"Set {env_email} and {env_password} in .env file")
        sys.exit(1)
